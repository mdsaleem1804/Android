...
public class GpsSettings extends Activity {
	...
	public void go(View v) {
		if ((xEdtLatitude.getText().toString().equalsIgnoreCase("77.7"))
				&& (xEdtLongtitude.getText().toString().equalsIgnoreCase("8.7"))) {
			Intent intent = new Intent(GpsSettings.this,
					HomePage.class);
			startActivity(intent);
		}
		if ((xEdtLatitude.getText().toString().equalsIgnoreCase("76.1"))
				&& (xEdtLongtitude.getText().toString().equalsIgnoreCase("8.1"))) {
			Intent intent = new Intent(GpsSettings.this,
					HomePage.class);
			startActivity(intent);
		}
		...
		{
			Toast.makeText(getApplicationContext(), "Invalid Value", 1000).show();
		}
	...
	mDrawerList.setOnItemClickListener(new OnItemClickListener() {
		...
		/*	if(position==0)
			...
			*/
			...
			String[] rivers = getResources().getStringArray(R.array.leftmenu);
