...
public class ListNewSchemes extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Bundle b = new Bundle(); b = getIntent().getExtras(); xSession =
		 * b.getString("formname");
		 */

		DataBaseConnection mCon;
		mCon = new DataBaseConnection(this);
		List<String> xListData = mCon.fn_GetSchemes("order by id desc limit 1");
