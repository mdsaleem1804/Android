...
public class DataBaseConnection extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		try {
			...
			xCart = "create table cart "
					+ "(pname varchar(50),pvendorname varchar(50),pusername varchar(50))";
			db.execSQL(xCart);
	...
	public Boolean fn_InsertCart(String xProductName, String xVendorName,
			String xUserName) {
	...
	public List<String> fn_GetCart(String xVendorName) {
		...
		try {
			...
			if (cursor.moveToFirst()) {
				do {
					xCartItem.add("Pr.Name " + cursor.getString(0) + "User "
							+ cursor.getString(2));
				} while (cursor.moveToNext());
			}
