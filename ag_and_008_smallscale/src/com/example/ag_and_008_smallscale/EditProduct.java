...
public class EditProduct extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			/*
			 * String[] separated = xProductName.split("-"); xProductName =
			 * separated[0]; xProductPrice = separated[1]; xVendorName =
			 * separated[2];
			 */
	...
	public void addcart(View v) {
		mCon.fn_InsertCart(xEdtAddProductName.getText().toString(),
				xGetVenderName, xGetUserName);
