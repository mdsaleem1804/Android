    ...
    protected void onStart() {
        ...
        Action viewAction = Action.newAction(
               ...
               // Uri.parse("android-app://net.simplifiedcoding.googlemapsdistancecalc/http/host/path")
                Uri.parse("android-app://com.hellotamila.ah_006_tourist/http/host/path")
        );
...
public class MapsActivity extends FragmentActivity implements
    ...
    protected void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                // make sure this auto-generated web page URL is correct.
                // Otherwise, set the URL to null.
                Uri.parse("android-app://com.hellotamila.ah_and_014_map_direction/http/host/path"),
                // TODO: Make sure this auto-generated app deep link URI is correct.
                Uri.parse("android-app://com.hellotamila.ah_and_014_map_direction/http/host/path")
        );
        AppIndex.AppIndexApi.start(googleApiClient, viewAction);
    ...
    private void getDirection(){
        ...
        String url = makeURL(fromLatitude, fromLongitude, toLatitude, toLongitude);
       */
/* double a= Double.parseDouble(obj.a());
        double b= Double.parseDouble(obj.b());
        double d= Double.parseDouble(obj.d());
        double e= Double.parseDouble(obj.e());*//*
...
/*   double a= 8.7;
    ...
    public void onClick(View v) {
        if(v == buttonSetFrom){
           fromLatitude = latitude;
            fromLongitude = longitude;
           // fromLatitude = 8.717077;
          // fromLongitude = 77.770956;
