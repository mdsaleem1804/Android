...
public class ListExpensesByCategory extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		List<String> xExpenses = mCon.fn_CheckExpenses("order by categoryname");
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent xIntent = new Intent(ListExpensesByCategory.this, EditExpenses.class);
