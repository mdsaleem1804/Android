...
public class ListExpensesByDate extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		List<String> xExpenses = mCon.fn_CheckExpenses("order by date");
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent xIntent = new Intent(ListExpensesByDate.this, EditExpenses.class);
