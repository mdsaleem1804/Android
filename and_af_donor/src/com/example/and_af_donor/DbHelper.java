...
/**
 * Created by Hasibuzzaman on 7/20/2016.
 */
public class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String COLOUMN_7_ADDR1 = "addressline1";
    public static final String COLOUMN_8_ADDR2 = "addressline2";
    ...
    public static final String CREATE_TABLE =
            "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " ( " + COLOUMN_1_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                    ...
                    COLOUMN_4_EMAIL + " text, " + COLOUMN_5_BLOODGROUP + " text, "+ COLOUMN_6_LAST_DATE + " text, " + COLOUMN_7_ADDR1 + " text, "+ COLOUMN_8_ADDR2 + " text);";
    ...
    public long insert(AddContacts addContacts, DonorInformation donorInfo) {
        ...
        cv.put(COLOUMN_7_ADDR1,donorInfo.addressline1);
        cv.put(COLOUMN_8_ADDR2,donorInfo.addressline2);
    ...
    public ArrayList<DonorInformation> getDatas(String SelctedBG) {
        ArrayList<DonorInformation> donorList = new ArrayList<DonorInformation>();
