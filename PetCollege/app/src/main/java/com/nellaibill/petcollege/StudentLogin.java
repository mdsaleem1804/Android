...
public class StudentLogin extends AppCompatActivity {
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(StudentLogin.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://hellotamila.com/barani/petcollege/login.inc.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equalsIgnoreCase("true"))
            {
                ...
                Toast.makeText(StudentLogin.this, "OOPs! Something went wrong. Connection Problem.", Toast.LENGTH_LONG).show();
