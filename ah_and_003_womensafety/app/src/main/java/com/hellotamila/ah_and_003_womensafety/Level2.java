...
public class Level2 extends AppCompatActivity {
    ...
    EditText xEdtMobileNo,xEdtLat,xEdtLong;
    String xImei;
...
String xError=e.toString();
 ...
 public void fn_Update_Low() {
     ...
     obj.setHighlat(xEdtLat.getText().toString(),xEdtLong.getText().toString(),xEdtMobileNo.getText().toString());
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(
                    "http://hellotamila.com/spiro/womensafety/updatehigh.php");
