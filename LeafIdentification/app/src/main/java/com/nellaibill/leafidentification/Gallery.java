...
public class Gallery extends AppCompatActivity {
    ...
    String ServerUploadPath ="http://nellaibill.com/ntech/android/leaf/img_upload_to_server.php" ;
    Button capturedImageButton,xBtnMatch;
    Intent xIntent;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UploadImageServer = (Button)findViewById(R.id.buttonUpload);
         capturedImageButton = (Button)findViewById(R.id.btn_Camera);
        xBtnMatch = (Button)findViewById(R.id.btn_Match);
        ...
        xBtnMatch.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                xIntent = new Intent(Gallery.this,
                        CompareImage.class);
    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(Gallery.this,string1,Toast.LENGTH_LONG).show();
