...
public class ParentMainPage extends Activity {
...
EditText xEdtUserMobileNo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.parentmainpage);
	...
	public void proceed(View v)
	{
		...
		mCon.insertUserDetails(xEdtUserMobileNo.getText().toString(),"parent");
		Intent intent = new Intent(ParentMainPage.this,
				ListView_User.class);
		intent.putExtra("usermobileno", xEdtUserMobileNo.getText().toString());
		intent.putExtra("userplace", "parent");
