...
public class MapsActivity extends FragmentActivity implements
    ...
    public void path1(View v) {
      //  line.remove();
        mMap.clear();
        fromLatitude = 12.922915;
        fromLongitude = 80.127456;
        toLatitude = 13.010236;
        toLongitude = 80.215651;
        getDirection();
    }
    public void path2(View v) {
        // line.remove();
        mMap.clear();
        fromLatitude = 13.047261;
        fromLongitude = 80.094531;
        toLatitude = 13.010236;
        toLongitude = 80.215651;
        getDirection();
    }
    public void path3(View v) {
        // line.remove();
        mMap.clear();
        fromLatitude = 12.983027;
        fromLongitude = 80.259400;
        toLatitude = 13.073226;
        toLongitude = 80.260921;
        getDirection();
    }
    @Override
    protected void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.hellotamila.ah_and_013_roadsense/http/host/path")
        );
    ...
    public String makeURL (double sourcelat, double sourcelog, double destlat, double destlog ){
        ...
        urlString.append("&key=AIzaSyC2h95Ue-2zEZ-gwv3XRSlv5rwfCbyeq9I");
    ...
    private void getDirection(){
        ...
        //String url = makeURL(8.713913, 77.756652, 8.183286, 77.411900);
    ...
    public void drawPath(String  result) {
        ...
        //LatLng from = new LatLng(8.7139,77.7567);
        //LatLng to = new LatLng(8.1833,77.4119);
        //Calculating the distance in meters
        Double distance = SphericalUtil.computeDistanceBetween(from, to);
        distance=distance/1000;
        //Displaying the distance
        Toast.makeText(this,String.valueOf(distance+" Kilometers"),Toast.LENGTH_SHORT).show();
        ...
        if(v == buttonSetFrom){
          // fromLatitude = latitude;
           // fromLongitude = longitude;
            fromLatitude = 8.713913;
           fromLongitude = 77.756652;
