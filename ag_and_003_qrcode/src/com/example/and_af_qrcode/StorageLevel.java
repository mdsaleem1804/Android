...
public class StorageLevel extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.storagelevel);
		...
		generate.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					qrDroidRequired(StorageLevel.this);
				}
			}
		});
	}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(ACTIVITY_RESULT_QR_DRDROID == requestCode 
			...
			//ImageView imgResult1 = ( ImageView ) findViewById(R.id.fimgDisplayImage);
			...
			//imgResult1.setImageBitmap(BitmapFactory.decodeFile(qrCode));
			//imgResult1.setImageURI( Uri.parse(qrCode) );
	...
	protected static void qrDroidRequired(final StorageLevel activity) {
		// TODO Auto-generated method stub
