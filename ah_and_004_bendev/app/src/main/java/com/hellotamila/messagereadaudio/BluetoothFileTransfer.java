...
public class BluetoothFileTransfer extends AppCompatActivity {
    //Create Objects-------------------------------------------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluetooth_file_transfer);
        ...
        if(xUrl.equalsIgnoreCase("L1"))
        {
            dataPath.setText("/storage/emulated/0/mus/a1.m4a");
            sendViaBluetooth();
            Handler handler = new Handler();
            handler.postDelayed(new Runnable() {
                public void run() {
                    dataPath.setText("/storage/emulated/0/mus/d1.docx");
                    sendViaBluetooth();
                }
            }, 20000);

          }
        else  if(xUrl.equalsIgnoreCase("L2"))
        {
            dataPath.setText("/storage/emulated/0/mus/a2.m4a");
            sendViaBluetooth();
            Handler handler = new Handler();
            handler.postDelayed(new Runnable() {
                public void run() {
                    dataPath.setText("/storage/emulated/0/mus/d2.doc");
                    sendViaBluetooth();
                }
            }, 20000);

        }
        else if(xUrl.equalsIgnoreCase("L3"))
        {
            dataPath.setText("/storage/emulated/0/mus/a3.m4a");
            sendViaBluetooth();
            Handler handler = new Handler();
            handler.postDelayed(new Runnable() {
                public void run() {
                    dataPath.setText("/storage/emulated/0/mus/d3.doc");
                    sendViaBluetooth();
                }
            }, 20000);
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case CUSTOM_DIALOG_ID:
                dialog = new Dialog(BluetoothFileTransfer.this);
